      ...
      if (BigNumber(allowance0).lt(amount0)) {
        ...
        const tokenPromise = new Promise((resolve, reject) => {
          context._callContractWait(
            ...
            tokenContract,
            'approve',
            [CONTRACTS.ROUTER_ADDRESS, amount0Bn],
            account,
            gasPrice,
            null,
            null,
      ...
      if (BigNumber(allowance1).lt(amount1)) {
        ...
        const tokenPromise = new Promise((resolve, reject) => {
          context._callContractWait(
            ...
            tokenContract,
            'approve',
            [CONTRACTS.ROUTER_ADDRESS, amount1Bn],
            account,
            gasPrice,
            null,
            null,
      ...
      if (BigNumber(stakeAllowance).lt(stakeAmount)) {
        ...
        const stakePromise = new Promise((resolve, reject) => {
          context._callContractWait(
            ...
            pairContract,
            'approve',
            [pair.gauge.address, stakeAmountBn],
            account,
            gasPrice,
            null,
            null,
      ...
      if (BigNumber(allowance).lt(withdrawAmount)) {
        ...
        const tokenPromise = new Promise((resolve, reject) => {
          context._callContractWait(
            ...
            tokenContract,
            'approve',
            [CONTRACTS.ROUTER_ADDRESS, withdrawAmountBn],
            account,
            gasPrice,
            null,
            null,
      ...
      if (BigNumber(allowance).lt(fromAmount)) {
        ...
        const tokenPromise = new Promise((resolve, reject) => {
          context._callContractWait(
            ...
            tokenContract,
            'approve',
            [CONTRACTS.ROUTER_ADDRESS, fromAmountBn],
            account,
            gasPrice,
            null,
            null,
      ...
      if (BigNumber(allowance).lt(amount)) {
        ...
        const tokenPromise = new Promise((resolve, reject) => {
          this._callContractWait(
            ...
            tokenContract,
            'approve',
            [CONTRACTS.VE_TOKEN_ADDRESS, amountBn],
            account,
            gasPrice,
            null,
            null,
      ...
      if (BigNumber(allowance).lt(amount)) {
        ...
        const tokenPromise = new Promise((resolve, reject) => {
          this._callContractWait(
            ...
            tokenContract,
            'approve',
            [gauge.gauge.bribeAddress, amountBn],
            account,
            gasPrice,
            null,
            null,
