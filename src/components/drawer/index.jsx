          ...
          >
            <Dialog.Panel className="flex flex-col fixed w-full max-w-96 scale-100 border border-border bg-gradient-primary rounded-2xl p-5">
              ...
              <ol className="space-y-[14px] text-sm mt-5">
                <li
                  key="metamask"
                  className="bg-table-dark rounded-[10px] border border-border overflow-hidden hover:border-border-highlight hover:bg-gradient-primary"
                >
                  <div className="flex flex-row justify-between items-center font-inter text-sm px-4 py-3 cursor-pointer">
                    MetaMask
                    <div className="flex justify-center items-center">
                      <Image src="/connectors/icn-metamask.svg" alt="" width={24} height={24} />
                    </div>
                  </div>
                </li>
                <li
                ...
                >
                  <div className="flex flex-row justify-between items-center font-inter text-sm px-4 py-3 cursor-pointer">
                    WalletConnect
                    <div className="flex justify-center items-center">
                      <Image src="/connectors/walletConnectV2Icon.svg" alt="" width={24} height={24} />
                    </div>
                  </div>
                </li>
              </ol>
