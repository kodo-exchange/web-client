  ...
  const renderAvailable = () => {
    return (
      <>
        ...
        <Typography className={classes.descriptionText} align="center">
          {formatCurrency(BigNumber(bribe.rewardPerToken).times(100).div(100))} {bribe.token.symbol}
        </Typography>
        <Typography className={classes.descriptionSubText} align="center">
          100% vote for {pair.symbol} gives you {formatCurrency(bribe.rewardPerToken)} {bribe.token.symbol}
        </Typography>
