...
export default function EnhancedTable({ rewards, tokenID }) {
  ...
  const [orderBy, setOrderBy] = React.useState('reward')
              ...
              return (
                <tr className="hover:bg-bg-light" key={'ssRewardsTable' + index}>
                  <td className="whitespace-nowrap text-sm leading-[18px] align-center px-4 md:px-6 py-4 text-left">
                    {['Fees', 'Reward'].includes(row.rewardType) && (
                      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-2 text-xs">
                        <div className="relative flex w-[62px] max-w-[62px] min-w-[62px] h-9">
                          ...
                          {/* <Image
                            ...
                            src={row.token1 && row.token1.logoURI ? row.token1.logoURI : '/tokens/unknown-logo.png'}
                            width={24}
                            height={24}
                            alt=""
                            onError={(e) => {
                  ...
                  <td className="whitespace-nowrap text-xs font-extralight align-top px-4 md:px-6 py-4 text-right">
                    ...
                    <div className="sm:hidden mt-4">
                      <div className="text-white">You Earned</div>
                      {row && row.rewardType === 'Reward' && (
                        <div className="flex flex-row gap-[4px] items-center justify-end text-white text-sm leading-[18px] font-medium">
                          <div className="">{formatCurrency(row.gauge.rewardsEarned)}</div>
                  ...
                  <td className="whitespace-nowrap text-xs font-extralight align-middle px-4 md:px-6 py-4 text-right hidden sm:table-cell">
                    {row && row.rewardType === 'Reward' && (
                      <div className="flex flex-row gap-[4px] items-center justify-end text-white text-sm leading-[18px] font-medium">
                        <div className="">{formatCurrency(row.gauge.rewardsEarned)}</div>
                        <div className="">KODO</div>
