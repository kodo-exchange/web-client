...
export default function BribeCreate() {
  ...
  useEffect(() => {
    const createReturned = (res) => {
      ...
      // onBack() // commented out to stop from redirecting to /vote
    }
                      ...
                      <div className={classes.menuOption}>
                        <div className={classes.doubleImages}>
                          ...
                          {/* <Image
                            className={`${classes.someIcon} ${classes.img1Logo}`}
                            alt=""
                            src={option && option.token0 ? `${option.token0.logoURI}` : '/tokens/unknown-logo.png'}
                            height={70}
                            width={70}
                            onError={(e) => {
                              e.target.onerror = null
                          ...
                          <Image
                            className={`${classes.someIcon} ${classes.img2Logo}`}
                            alt=""
                            src={option && option.token1 ? `${option.token1.logoURI}` : '/tokens/unknown-logo.png'}
                            height={70}
                            width={70}
                            onError={(e) => {
                              e.target.onerror = null
